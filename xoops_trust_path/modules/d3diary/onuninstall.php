...
eval( ' function xoops_module_uninstall_'.$mydirname.'( $module ) { return d3diary_onuninstall_base( $module , "'.$mydirname.'" ) ; } ' ) ;


if( ! function_exists( 'd3diary_onuninstall_base' ) ) {
...
function d3diary_message_append_onuninstall( &$module_obj , &$log )
{
