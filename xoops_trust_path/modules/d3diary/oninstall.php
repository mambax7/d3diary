...
eval( ' function xoops_module_install_'.$mydirname.'( $module ) { return d3diary_oninstall_base( $module , "'.$mydirname.'" ) ; } ' ) ;


if( ! function_exists( 'd3diary_oninstall_base' ) ) {
...
function d3diary_message_append_oninstall( &$module_obj , &$log )
{
